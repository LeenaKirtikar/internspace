                            ...
                            <div class="container">
                                ...
                                <!-- single-job-content -->
                                        ...
                                        <?php
                                         ...
                                         {
                                             $sql1="select * from internship, recruiter where internship.CompanyId=recruiter.CompanyId";
                                    ...
                                    <div class="items-link items-link2 f-right">
                                        ...
                                        <input type="hidden" name="intid" value="<?php echo $row["InternshipId"]; ?>">
