...
<div class="signup-form">
    <form action="registration.php" method="post">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="num" placeholder="Contact number" required="required">
        </div>   
        <div class="form-group">
...
{
	$sql1="insert into student (Username,FirstName,LastName,EmailId,Pass,Address,Gender,ContactNumber,Stream,City) values ('".$username."','".$fname."','".$lname."','".$email."','".$password."','".$add."','".$gender."','".$num."','".$stream."','".$city."')";
