...
#customers th {
 ...
 -->        <!-- slider Area End-->
    ...
    else
    {
        ...
        $query = "select * from student_internship,recruiter,student,internship where recruiter.CompanyId='".$CompanyId."' and recruiter.CompanyId=internship.CompanyId and student.Username = student_internship.Username and internship.InternshipId= student_internship.InternshipId";
...
?>
    ...
    <input type="submit" class="btn head-btn1" value="Add internship">
    ...
    <form method="POST" action="viewinternships.php">
    <div class="header-btn d-none f-right d-lg-block">
    <input type="submit" class="btn head-btn1" value="View internship">
    <input type="hidden" name="CompanyId" value='<?php echo $CompanyId;?>'>
</div>
<br><br><br><br><br><br>
